...
const VTest15: React.FC = () => {
    const [images, setImages] = useState<ImageData[]>([]);
    const [loading, setLoading] = useState(false);
    //       vtest3 is tango20381.15
        ...
        try {
            ...
            const response = await fetch('https://piclumen.com/api/gen/create', {
                ...
                headers: {
                    ...
                    'Authorization': '624f01785bc4fcdb4056053bc79bc14f776aa07a',
                    'Content-Type': 'application/json;charset=UTF-8',
                    'Cookie': '_fbp=fb.1.1730283423363.336839037583177413; _ga=GA1.1.942354925.1730283423; g_state={"i_l":0}; _ga_8GVHYJ2FGV=GS1.1.1732086622.6.1.1732086746.0.0.0',
    ...
    const downloadImage = async (imgUrl: string) => {
        try {
            ...
            // Suggest the subfolder in the filename
            const suggestedPath = `folder1/image_${Date.now()}.jpg`;

            const link = document.createElement('a');
            link.href = blobUrl;
            link.download = suggestedPath; // Suggested subfolder in the filename
            link.click();
